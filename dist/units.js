...
function celsiusTo(value, target) {
    switch (target) {
        case 'c': return value;
...
function toCelsius(value, source) {
    switch (source) {
        case 'c': return value;
...
function roundValue(value, maxDecimals) {
 ...
 */
export function convert(value, fromRaw, toRaw, maxDecimals = 6) {
...
export function listUnits(categoryFilter) {
